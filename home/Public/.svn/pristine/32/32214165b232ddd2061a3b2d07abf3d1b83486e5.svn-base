$(function(){
  ...
  if(i==1 || i==3){
    ...
    $(".feedback-bg").mouseover(function(){
        $(".feedback-bg > .front").hide()
        $(".feedback-bg > .back").show();
    });
    $(".feedback-bg").mouseout(function(){
        $(".feedback-bg > .back").hide()
        $(".feedback-bg > .front").show();
    });
    $(".totop-bg").mouseover(function(){
        $(".totop-bg > .front").hide()
        $(".totop-bg > .back").show();
    });
    $(".totop-bg").mouseout(function(){
        $(".totop-bg > .back").hide()
        $(".totop-bg > .front").show();
    });
